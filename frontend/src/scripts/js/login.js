...
if (!loginForm ||
    ...
    var handleLogin = function (event) { return __awaiter(_this, void 0, void 0, function () {
        var form, role, email, password, loginData, response, token, roleId, error_1;
    ...
    var handleSignup = function (event) { return __awaiter(_this, void 0, void 0, function () {
        var form, username, roleId, email, password, confirmPassword, userData, response, token, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    event.preventDefault();
                    ...
                    userData = { email: email, username: username, password: password, roleId: roleId };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
