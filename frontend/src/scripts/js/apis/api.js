...
// Fetch User Details
var fetchUserDetails = function (queue_id) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            fetch("http://localhost:4000/api/v1/queues/".concat(queue_id)),
          ];
        case 1:
          response = _a.sent();
          if (!response.ok) {
...
var deleteUserFromQueue = function (queue_id) {
  return __awaiter(void 0, void 0, void 0, function () {
    var error_4;
    return __generator(this, function (_a) {
      switch (_a.label) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            fetch("http://localhost:4000/api/v1/users/".concat(user_id), {
              method: "DELETE",
            }),
          ];
        case 1:
          ...
          if (!response.ok) {
            throw new Error(
              "Failed to delete user: ".concat(response.statusText)
            );
          }
          return [3 /*break*/, 3];
        case 2:
...
var updateUserStatus = function (queue_id, newStatus) {
  return __awaiter(void 0, void 0, void 0, function () {
    var error_6;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
// Register Patient
var registerPatient = function (patientData, token) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var addToQueue = function (queueData, token) {
  return __awaiter(void 0, void 0, void 0, function () {
