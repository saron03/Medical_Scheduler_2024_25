    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            fetch("http://localhost:4000/api/v1/users/user", {
              method: "GET",
              headers: {
...
var renderProfile = function (user) {
  ...
  if (user) {
    ...
    profileSection.innerHTML =
      '\n      <img src="imgs/profile.png" alt="Profile Picture">\n        <h3>'
        .concat(user.username, "</h3>\n        <p>Role: ")
        .concat(user.role.name, "</p>\n        <p>Email: ")
        .concat(user.email, "</p>\n        <p>Created At: ")
        .concat(new Date(user.created_at).toLocaleString(), "</p>\n      ");
  } else {
  ...
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      if (!editProfileForm || !profileSection) {
        console.error(
          "Edit profile form or profile section element not found."
        );
        return [2 /*return*/];
      }
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                return [
                  4 /*yield*/,
                  fetch(
                    "http://localhost:4000/api/v1/users/".concat(user.user_id),
                    {
                      method: "PUT",
              ...
              case 2:
                ...
                if (!updateResponse.ok) {
                  throw new Error(
                    "HTTP error! status: ".concat(updateResponse.status)
                  );
                }
