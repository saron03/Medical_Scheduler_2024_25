...
var addUser = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var firstName, lastName, email, phoneNumber, dob, gender, address, registeredById, doctorId, patientData, patientResponse, patient, queueData, queueResponse, queueEntry, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
