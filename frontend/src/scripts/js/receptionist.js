    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          pendingEntries = users.filter(function (user) {
    ...
    var row = '\n        <tr class="'
      ...
      .concat(
        user.status === 1
          ...
          ? "Pending"
          : "Resolved Pending",
        '</td>\n          <td>\n            <button style="border: none; color: white;" class="btn btn-sm" onclick="resolvePendingUser('
      )
      .concat(index, ')" ')
      .concat(
        resolveButtonDisabled ? "disabled" : "",
        '>Resolve Pending</button>\n            <button style="border: none; color: white;" class="btn btn-sm" onclick="deleteUser('
      )
...
var resolvePendingUser = function (index) {
  return __awaiter(_this, void 0, void 0, function () {
    var user, error_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
